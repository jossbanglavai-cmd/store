...
export const OrdersView: React.FC<Props> = ({ orders, onBackToHome }) => {
  return (
    <div className="max-w-2xl mx-auto w-full space-y-4 animate-in fade-in duration-200">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-gray-200">
        ...
        <button
          ...
          className="text-xs font-semibold text-black hover:underline flex items-center gap-1 bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg transition"
        >
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-2xl p-10 sm:p-14 text-center border border-gray-200 shadow-xs flex flex-col items-center justify-center">
          ...
          <button
            onClick={onBackToHome}
            className="px-5 py-2.5 bg-black hover:bg-neutral-800 text-white text-xs font-bold rounded-xl transition shadow-xs"
          >
        ...
        <div className="space-y-3.5">
          {orders.map((order) => {
            ...
            return (
              <div
                key={order.id}
                className="bg-white rounded-2xl border border-gray-200/90 p-5 shadow-xs hover:shadow-md transition flex flex-col justify-between"
              >
                <div>
